...
export function Sidebar({ role }: { role: Role }) {
  ...
  return (
    <aside className="w-60 shrink-0 bg-navy text-paper min-h-screen flex flex-col no-print">
      <div className="px-5 py-5 border-b border-paper/10">
        ...
        <p className="text-[11px] text-paper/50">{role.charAt(0) + role.slice(1).toLowerCase()} Portal</p>
      </div>
